...
// *******
if (document.getElementById("platform-submit")) {

  function nextPage() {
    document.getElementById("platform-submit").href = "/" + "genres";
  } else {
    function nextPage() {
      document.getElementById("genre-submit").href = "/" + "cards";
    }
  }
...
// document.getElementById("genre-submit").onclick = function () {
//   location.href = "/cards";
// };
// // direct the user to the next page
// document.getElementById("platform-submit").onclick = function () {
